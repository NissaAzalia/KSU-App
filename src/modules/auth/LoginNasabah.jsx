      ...
      <div className="flex flex-col bg-[#FFFFFF] text-[#2C6975] h-[100%] md:w-full justify-center">   
        ...
        <div className="md:px-full px-[25px] md:my-[120px] my-[40px]">
          ...
          <div className="mb-[25px]">
            ...
            <p className="text-[13px] mt-[10px] text-[#6f6f6f] hover:text-[#2C6975]">Klik disini untuk login Admin. <span onClick={handleClickAdmin} className="text-[#4a9de6] cursor-pointer">Klik!</span></p>
          </div>
