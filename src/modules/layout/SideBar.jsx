        ...
        <>
            <div className="text-center  bg-white w-[300px] h-screen  ">
                ...
                <div className=" mt-[30px]">
                    <NavLink to={"/daftar-anggota"} className="animate flex hover:bg-[#2C6975] text-[#626262] hover:text-white gap-[10px] h-[50px] pt-[10px] pl-[30px] "
                        style={({ isActive }) => ({
                    ...
                    <NavLink to={"/input-simpanan"} className="animate flex hover:bg-[#2C6975] text-[#626262] hover:text-white gap-[10px] h-[50px] pt-[10px] pl-[30px] "
                        style={({ isActive }) => ({
                            background: isActive ? "#2C6975" : "transparent",
                            color: isActive ? "white" : "#626262"
                        })}>
                ...
                <NavLink to={"/"}>
                    <div
                        className="animate w-[300px]  flex hover:bg-[#2C6975] hover:text-white gap-[10px]  h-[50px] pt-[10px] px-[100px] mt-[257px] ">
