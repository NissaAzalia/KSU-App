        ...
        <div className="bg-[#F4F4F4] w-screen h-screen ">
            ...
            <div className="ml-[100px] mt-[50px]">
                ...
                <div className=" mx-[5px] pt-[10px]">
                    <input className="rounded-xl w-[700px] h-[40px] border-solid border-[1px]  shadow-lg" type="text" placeholder="" />
                        <FontAwesomeIcon icon={faMagnifyingGlass} className=" text-[#7D7D7D] " />
                </div>
            </div>
